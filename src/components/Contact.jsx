...
const Contact = () => {
    ...
    emailjs.send(
      ...
      "template_nfisfqg",

        {
          ...
          to_email: "armanlaleh24@gmail.com",
      ...
      .then(
        () => {
          setLoading(false);
          alert("Takk. Jeg svarer deg så fort som mulig :)");
  ...
  return (
    ...
    >
      ...
      >
        <p className={styles.sectionSubText}>Send en melding</p>
        ...
        >
          ...
          <label className='flex flex-col'>
            ...
            <textarea
              ...
              value={form.message}
              onChange={handleChange}
              placeholder='Hva ønsker du å skrive?'
              className='bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium'
            />
          </label>
